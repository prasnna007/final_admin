...
public class Book {
	...
	public String toString() {
		return "Book [id=" + id + ", title=" + title + ", author=" + author + ", publisher=" + publisher
				...
				+ ", bookImage=" + bookImage + ", bookToCartItem=" + bookToCartItem + "]";
	}

	public Book(int id, String title, String author, String publisher, String publicationDate, String language,
			String category, String format, int isbn, double listPrice, double ourPrice, double shippingWeight,
			int noOfPages, boolean active, int sellerId, String description, int inStockNumber) {
		super();
		this.id = id;
		this.title = title;
		this.author = author;
